...
Paul and Theo also added a *possession value*-type model (I haven't checked it out yet) and have written about all the above in their [paper](https://arxiv.org/abs/2101.05388){target="_blank"}. You can find the code [here](https://github.com/DonsetPG/narya){target="_blank"}.
...
To generate the training data I have used a streamlit app based on [BirdsPyView](https://github.com/rjtavares/BirdsPyView){target="_blank"} by [Ricardo Tavares](https://twitter.com/rjtavares){target="_blank"}. This app allows me to generate training data very efficiently. If you want to try it out you can find the code [here](https://github.com/larsmaurath/narya-label-creator){target="_blank"}.
